...
public class GuicheConsumerConfigImpl implements GuicheConsumerConfig {
    ...
    public ConsumerFactory<String, Ficha> consumerFactory() {
        ...
        configs.put(JsonDeserializer.VALUE_DEFAULT_TYPE,"com.h_salvacao.ms_guiche.model.Ficha");
...
//
    ...
    @Override
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Ficha> tokenContainerFactory(
            ConsumerFactory<String, Ficha> consumerFactory
    ) {
        var factory = new ConcurrentKafkaListenerContainerFactory<String, Ficha>();
